...
class EmailSender:
    ...
    def _get_access_token(self) -> str:
        ...
        try:
            ...
            self.logger.write(
                f"Failed to acquire Microsoft Graph access token: {exc}",
                level="error",
            )
    ...
    def _send_payload(
        ...
        try:
            ...
            self.logger.write(
                f"Failed to send email payload: {exc}",
                level="error",
            )
    ...
    def create_email(
        ...
        self.logger.write("Draft email created successfully.", level="info")
    ...
    def add_attachment(
        ...
        self.logger.write(
            f"Added attachment to draft email: {file_name}",
            level="info",
        )
    ...
    def send(self) -> dict[str, Any]:
        ...
        self.logger.write(
            f"Draft email sent successfully to {final_recipients}.",
            level="info",
        )
